module "eks_managed_node_group" {
  ...
  vpc_security_group_ids = compact(
    concat(
      ...
      aws_eks_cluster.default[*].vpc_config[*].cluster_security_group_id,
  ...
  metadata_options                   = try(each.value.metadata_options, var.managed_node_group_defaults.metadata_options, null)
